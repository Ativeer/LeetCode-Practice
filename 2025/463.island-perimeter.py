        ...
        for i in range(len(grid)):
            for j in range(len(grid[0])):
                if grid[i][j] == 1:
                    ...
                    perimeter += 4
                    # if the column before this has a 1 value then remove the 2 sides corroponding to it

                    if i > 0 and grid[i-1][j] == 1:
                        perimeter -= 2
                    # if the row above this has a 1 value then remove the 2 sides corroponding to it
